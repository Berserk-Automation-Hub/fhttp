...
func newStaticTable(lastMatch bool) *headerFieldTable {
	...
	//               literal-with-indexed-name observations, zero exceptions.
	...
	// command, the census scope and the attribution rule are in PATCHES.md, "Ground truth"; running
	// it is how these numbers are checked, and they reproduce exactly.
	//
